...
class DataPreprocessor41:
    ...
    def __init__(self, trainFilePath="./Data_Twitter/ExperimentalData/Train/", testFilePath="./Data_Twitter/ExperimentalData/Test/",
                 devFilePath="./Data_Twitter/ExperimentalData/Dev/", doc2vecModelPath="./models_Twitter/d2v_alllines.model",
                 logFilePath="./Data_Twitter/log.txt"):
        '''
    ...
    def __transformDataIntoXY(self,dataDir):
        X = []
        Y = []
        model = Doc2Vec.load('./models_Twitter/d2v_alllines.model')
        print(len(model.docvecs))
        logDict = {}
        fileNameNoDict = {}
        logFileLines = open("./Data_Twitter/logFile.txt", mode="r", encoding="utf-8").readlines()
...
#     dataPreprocessor4=DataPreprocessor4()
#     dataPreprocessor4.getTrainData()
#     dataPreprocessor4.getTestData()
#     dataPreprocessor4.getDevData()

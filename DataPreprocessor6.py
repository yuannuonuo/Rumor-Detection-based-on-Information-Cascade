...
class DataPreprocessor6:
    ...
    def __init__(self, trainFilePath="./Data_Twitter3/ExperimentalData/Train/", testFilePath="./Data_Twitter3/ExperimentalData/Test/",
                 devFilePath="./Data_Twitter3/ExperimentalData/Dev/", doc2vecModelPath="./models_Twitter3/d2v_alllines.model",
                 logFilePath="./Data_Twitter3/logFile.txt"):
        '''
    ...
    def __transformDataIntoXY(self,dataDir):
        X = []
        Y = []
        model = Doc2Vec.load('./models_Twitter3/d2v_alllines.model')
        print(len(model.docvecs))
        logDict = {}
        fileNameNoDict = {}
        logFileLines = open("./Data_Twitter3/logFile.txt", mode="r", encoding="utf-8").readlines()
                        ...
                        if text != "" and len(text.split(" ")) >= 2 and text != " " and text != "  " and text != "   ":
                            ...
                            try:
                                ...
                                currentFileVectors.append(
                                    np.array([float(0.0) for i in range(self.para_embedding_size)]))
                        else:
...
#     dataPreprocessor5=DataPreprocessor5()
#     dataPreprocessor5.getTrainData()
#     dataPreprocessor5.getTestData()
#     dataPreprocessor5.getDevData()

...
class DataPreprocessor2:
    ...
    def __init__(self, trainFilePath="./Data2/ExperimentalData/Train/", testFilePath="./Data2/ExperimentalData/Test/",
                 devFilePath="./Data2/ExperimentalData/Dev/", doc2vecModelPath="./models2/d2v_alllines.model",
                 logFilePath="./Data2/log.txt"):
        '''
...
if __name__ == '__main__':
    dataPreprocessor2=DataPreprocessor2()
    dataPreprocessor2.getTrainData()
    dataPreprocessor2.getTestData()
    dataPreprocessor2.getDevData()

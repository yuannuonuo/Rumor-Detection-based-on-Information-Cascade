...
class DataPreprocessor5:
    ...
    def __init__(self, trainFilePath="./Data_Twitter2/ExperimentalData/Train/", testFilePath="./Data_Twitter2/ExperimentalData/Test/",
                 devFilePath="./Data_Twitter2/ExperimentalData/Dev/", doc2vecModelPath="./models_Twitter2/d2v_alllines.model",
                 logFilePath="./Data_Twitter2/logFile.txt"):
        '''

...
class DBCN_Model:
    ...
    modelSavingPath = "./models_Twitter2/networks/dbcn/"
    ...
    def __init__(self, shuffle_size=20, batch_size=16,
                 ...
                 initial_learning_rate=0.00002, epoch_num=20):
        '''
        ...
        self.para_embedding_size = DataPreprocessor1.DataPreprocessor1.para_embedding_size
        self.group_num = DataPreprocessor1.DataPreprocessor1.group_num
